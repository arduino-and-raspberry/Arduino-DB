DROP SCHEMA IF EXISTS arduino CASCADE;

CREATE SCHEMA arduino AUTHORIZATION postgres;


create function arduino.update_user_created_date() returns trigger
	language plpgsql
as $$
BEGIN
...
CREATE SEQUENCE arduino.temp_id_seq   INCREMENT 1   MAXVALUE 9223372036854775807 CACHE 1;
...
ALTER TABLE arduino.logs
  RENAME COLUMN who TO "Who";